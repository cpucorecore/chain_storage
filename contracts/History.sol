...
contract History is Importable, IHistory {
    ...
    function getUserHistory(uint256 index) external view returns (uint256, address, uint256, bytes32) {
    ...
    function getNodeHistory(uint256 index) external view returns (uint256, address, uint256, uint256, bytes32) {
    ...
    function getMonitorHistory(uint256 index) external view returns (uint256, address, uint256, uint256, bytes32) {
