...
interface IHistory {
    ...
    function addUserAction(address addr, uint256 actionType, bytes32 cidHash) external;
    function getUserHistoryNumber() external view returns (uint256);
    function getUserHistory(uint256 index) external view returns (uint256, address, uint256, bytes32); // (timestamp, addr, actionType, cidHash)
    ...
    function addNodeAction(address addr, uint256 tid, uint256 actionType, bytes32 cidHash) external;
    function getNodeHistoryNumber() external view returns (uint256);
    function getNodeHistory(uint256 index) external view returns (uint256, address, uint256, uint256, bytes32); // (timestamp, addr, tid, actionType, cidHash)
    ...
    function addMonitorAction(address addr, uint256 tid, uint256 actionType, bytes32 cidHash) external;
    function getMonitorHistoryNumber() external view returns (uint256);
    function getMonitorHistory(uint256 index) external view returns (uint256, address, uint256, uint256, bytes32); // (timestamp, addr, tid, actionType, cidHash
